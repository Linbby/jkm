<template>
  <div>
    ...
    <div class="module"> 
      ...
      <div class="table">
        <el-table :data="tableData" style="width: 100%" v-loading=reverseloading>
          ...
          <el-table-column prop="district_id" label="行政区" width="120">
          </el-table-column>
          <el-table-column prop="street_id" label="街道" width="120"
            >
          </el-table-column>
          <el-table-column prop="community_id" label="社区">  </el-table-column>
